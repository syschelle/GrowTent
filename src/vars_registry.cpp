...
static String g_largest_heap_block() { return jUInt((uint32_t)heap_caps_get_largest_free_block(MALLOC_CAP_8BIT));}
...
const VarItem VARS[] = {
  ...
  {"sys.largestFreeHeapBlock", g_largest_heap_block, false, "system"},
